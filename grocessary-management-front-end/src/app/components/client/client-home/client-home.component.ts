...
export class ClientHomeComponent implements OnInit {
  ...
  customer: any = {};
  getCategoryList: any[] = [];
  category: any = 100;  //to initially allow to display all product
...
// to chk customer present or not if yes get details
...
// if all selected in dropdown give all product also give the enter category product
